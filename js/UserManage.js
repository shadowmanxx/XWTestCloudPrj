...
function Query(callback,UserId){
...
function PageInit(){
      ...
      switch(CurId){
        case "Create":
          ...
          Handler = function(Result){
            ...
            Query(HandleQueryUserInfo,Result.user_id);
          };
          break;
        case "Modify":
          Method = "PUT";
          ...
          (function(UserId){
            Handler = function(Result){
              ...
              Query(HandleQueryUserInfo,UserId);
            };
          }(UserId));
  ...
  Query(HandleQueryUserInfo,null);
